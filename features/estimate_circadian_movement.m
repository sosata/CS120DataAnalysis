...
f_circadian_low = 1/(86400+30*60);%1/(86400+30*60);
f_circadian_high = 1/(86400-30*60);%1/(86400-30*60);
...
energy1 = sum(P1((F1>=f_circadian_low)&(F1<=f_circadian_high)));
energy2 = sum(P2((F2>=f_circadian_low)&(F2<=f_circadian_high)));
