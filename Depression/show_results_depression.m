...
subplot(1,3,3);
hold on;
bar(1:3, [nanmean(nanmean(auc_1)),nanmean(nanmean(auc_2)),nanmean(nanmean(auc_3))]*100,'facecolor',[0 1 1]);
...
text(-3, 93,'\bf PHQ9 Prediction','HorizontalAlignment' ,'center','VerticalAlignment', 'top', 'fontsize', 12);
